...
dt = 0.1  # Time step size (seconds) - Increased for efficiency
total_time = 300.0  # Total simulation time (5 minutes = 300 seconds)
...
plt.ylabel('Time (s)')
plt.title('Heat Distribution in a Metal Rod Over 5 Minutes')
